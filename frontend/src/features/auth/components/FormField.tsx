  ...
  return (
    <div className="space-y-1.5 w-full">
      ...
      <input
        id={id}
        {...props}
        className={`h-11 w-full rounded-lg border px-4 text-sm bg-white dark:bg-zinc-900 transition-all focus:outline-none focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 ${
          error
