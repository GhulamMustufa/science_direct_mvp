      ...
      {user ? (
        <>
          ...
          <div className="flex items-center gap-4 border-l border-zinc-200 pl-4 dark:border-zinc-800">
            <Link href="/profile" className="text-xs font-semibold text-zinc-700 hover:text-blue-600 dark:text-zinc-300 dark:hover:text-blue-400">
        ...
        <Link href="/login">
          <Button size="sm" className="bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-700 hover:to-indigo-700 text-white rounded-full">
            Sign In
          </Button>
        </Link>
      )}
