        ...
        <div className="bg-white dark:bg-zinc-900 p-6 rounded-lg border border-zinc-200 dark:border-zinc-800 shadow-sm space-y-4">
          ...
          <div className="space-y-3">
            ...
            <label className="flex items-start gap-3 p-3 rounded-md hover:bg-zinc-50 dark:hover:bg-zinc-800/50 cursor-pointer transition">
              ...
              />
              <span className="text-sm text-zinc-600 dark:text-zinc-400">
                <strong>Style & Layout:</strong> The text uses 1.5 line spacing; uses Times New Roman 12-point font (14-point for title) with 1 inch margins; employs italics rather than underlining; and all illustrations, figures, and tables are placed within the text.
              </span>
            </label>
