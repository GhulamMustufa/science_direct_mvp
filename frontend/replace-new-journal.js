const fs = require('fs');
let content = fs.readFileSync('src/app/admin/journals/new/page.tsx', 'utf8');
...
content = content.replace(/setIsSubmitting\(true\);\n    setError\(null\);\n    try \{\n      await adminService\.createJournal\(formData\);/g, submitLogic);
...
fs.writeFileSync('src/app/admin/journals/new/page.tsx', content);
